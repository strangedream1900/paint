...
exports.test_returnsHomePageWhenAskedForIndex = function (test) {
    ...
    httpGet("http://192.168.129.140:8089/index.html", function (response, responseData) {
        test.equals(200, response.statusCode, "status code");
        test.done();
    });
};
...
exports.test_runsCallbackWhenStopCompletes = function (test) {
    server.start(TEST_HOME_PAGE, TEST_404_PAGE, 8089);
...
function httpGet(url, callback) {
    ...
    server.start(TEST_HOME_PAGE, TEST_404_PAGE, 8089, function () {
